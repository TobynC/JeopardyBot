let nodeCache,jeopardyApiUrl,states,startDate,axios;_fa4‍.x([["showLeaderBoard",()=>showLeaderBoard],["showCategories",()=>showCategories],["showQuestion",()=>showQuestion],["checkAnswer",()=>checkAnswer]]);_fa4‍.w("./state",[["nodeCache",["nodeCache"],function(v){nodeCache=v}]]);_fa4‍.w("./constants",[["jeopardyApiUrl",["jeopardyApiUrl"],function(v){jeopardyApiUrl=v}],["states",["states"],function(v){states=v}],["startDate",["startDate"],function(v){startDate=v}]]);_fa4‍.w("axios",[["default",["axios"],function(v){axios=v}]]);
    ...
    axios.get(`${jeopardyApiUrl}/${date}`).then(response => {
        ...
        _fa4‍.g.console.log('user:', user);
    }).catch(error => _fa4‍.g.console.log(error));
}
    ...
    _fa4‍.g.console.log(user);
}

       function checkAnswer(client, channel, userState, self, response) {
    _fa4‍.g.console.log('response', response);
    const user = nodeCache.get(userState.username);
