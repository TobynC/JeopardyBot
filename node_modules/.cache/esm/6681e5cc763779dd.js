let nodeCache,jeopardyApiUrl,states,startDate,axios;_763‍.x([["showMoney",()=>showMoney],["showLeaderBoard",()=>showLeaderBoard],["showCategories",()=>showCategories],["showQuestion",()=>showQuestion],["checkAnswer",()=>checkAnswer]]);_763‍.w("./state",[["nodeCache",["nodeCache"],function(v){nodeCache=v}]]);_763‍.w("./constants",[["jeopardyApiUrl",["jeopardyApiUrl"],function(v){jeopardyApiUrl=v}],["states",["states"],function(v){states=v}],["startDate",["startDate"],function(v){startDate=v}]]);_763‍.w("axios",[["default",["axios"],function(v){axios=v}]]);



       function showMoney(client, channel, userState, self) {
    ...
    client.say(channel, `@${userState.username} ${output}`);
       ...
       function showCategories(client, channel, userState, self) { 
    ...
    axios.get(`${jeopardyApiUrl}/${date}`).then(response => {
        ...
        _763‍.g.console.log('user:', user);
    }).catch(error => _763‍.g.console.log(error));
}

       function showQuestion(client, channel, userState, self, responses) {
    ...
    _763‍.g.console.log(user);
}

       function checkAnswer(client, channel, userState, self, response) {
    _763‍.g.console.log('response', response);
    const user = nodeCache.get(userState.username);
