let tmi,nodeCache,lastWipe,checkAnswer,showCategories,showLeaderBoard,showQuestion,botName,oAuthToken,channelName,timeLimit,states;_ee2‍.w("tmi.js",[["default",["tmi"],function(v){tmi=v}]]);_ee2‍.w("./state",[["nodeCache",["nodeCache"],function(v){nodeCache=v}],["lastWipe",["lastWipe"],function(v){lastWipe=v}]]);_ee2‍.w("./jeopardy",[["checkAnswer",["checkAnswer"],function(v){checkAnswer=v}],["showCategories",["showCategories"],function(v){showCategories=v}],["showLeaderBoard",["showLeaderBoard"],function(v){showLeaderBoard=v}],["showQuestion",["showQuestion"],function(v){showQuestion=v}]]);_ee2‍.w("./constants",[["botName",["botName"],function(v){botName=v}],["oAuthToken",["oAuthToken"],function(v){oAuthToken=v}],["channelName",["channelName"],function(v){channelName=v}],["timeLimit",["timeLimit"],function(v){timeLimit=v}],["states",["states"],function(v){states=v}]]);
...
client.connect().catch(_ee2‍.g.console.error);
...
client.on('message', (channel, userState, message, self) => {
    ...
    else if (nodeCache.get(userState.username).state !== undefined) {
